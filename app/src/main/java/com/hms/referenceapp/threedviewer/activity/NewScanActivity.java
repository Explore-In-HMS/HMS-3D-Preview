...
import com.hms.referenceapp.threedviewer.dialog.PreviewConfigDialog;
import com.hms.referenceapp.threedviewer.R;
import com.hms.referenceapp.threedviewer.dialog.ProgressCustomDialog;
import com.hms.referenceapp.threedviewer.dialog.ShootingStepsDialog;
import com.hms.referenceapp.threedviewer.dialog.TurntableSpeedDialog;
import com.hms.referenceapp.threedviewer.dialog.UploadDialog;
import com.hms.referenceapp.threedviewer.activity.utils.ConstantBean;
import com.hms.referenceapp.threedviewer.activity.utils.CameraXManager;
...
public class NewScanActivity extends AppCompatActivity implements UploadDialog.OnItemSureClickListener, ProgressCustomDialog.OnItemCancelClickListener, UploadDialog.OnItemCancelClickListener, SensorEventListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        camMode = getIntent().getIntExtra("CAMERA_MODE", 1);
        if (camMode == 2) {
    ...
    void showInitUi() {
        scanModel = ConstantBean.SCAN_MODEL_TYPE_TWO;
        screenType = ConstantBean.SCREEN_MODEL_TYPE_ONE;
        if (!Once.beenDone("SHOW_STEPS")) {
            rlTopTips.setVisibility(View.VISIBLE);
            Once.markDone("SHOW_STEPS");
        } else {
